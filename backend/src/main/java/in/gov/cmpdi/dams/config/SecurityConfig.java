...
import in.gov.cmpdi.dams.security.JwtAuthenticationFilter;
import in.gov.cmpdi.dams.security.JwtTokenProvider;
import in.gov.cmpdi.dams.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/reports/approve/**", "/api/reports/return/**").hasAnyRole("DEPT_EXEC", "ADMIN")
